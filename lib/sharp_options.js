function applyOptions(rawImage, options) {
  ...
  if(options.forceFormat){
      force.jpg = options.forceFormat === 'jpg'
      force.webp = options.forceFormat === 'webp'
      force.tiff = options.forceFormat === 'tiff'
  }
  return rawImage
    .jpeg({quality: value, force: force.jpg})
    .webp({quality: value, force: force.webp})
    .tiff({quality: value, force: force.tiff})
}
